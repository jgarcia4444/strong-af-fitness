...
const Banner = () => {
    ...
    return (
        <div className="flex flex-row items-stretch gap-2 h-64 w-full">
            <div className=" relative w-1/5 rounded h-full bg-gray-600 border-2 border-white">
                <Image src='/banner-images/vertical-example.jpg' alt='Vertical Gym Image' width={240} height={480} className="w-full h-full"/>
            </div>
